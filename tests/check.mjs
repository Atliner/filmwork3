...
const deliveryCtx = vm.createContext({
  ...
  versionSources:mod.versionSources, hydrateSource:s=>s, resolveMirrorSource:async(_store,s)=>s, htmlEscape:s=>s,
...
deliveryCtx.deliverWithMirrorFallback=async(_store,token,chat,src,cap,extra)=>deliveryCtx.deliverMedia(token,chat,src,cap,extra);
