...
const mod = await import('data:text/javascript;base64,' + Buffer.from(source + '\nexport { APP_HTML, apiAuthTicket, signupBonusOf, telegramDisplayName, createTgUser, bustSettings, parseStarPacks, Store, saveUser, saveItemRecord, itemSourceKeys, maintenanceBatch };').toString('base64'));
